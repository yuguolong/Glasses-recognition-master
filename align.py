                ...
                if rectangles != []:
                    ...
                    for rectangle in rectangles:
                        if rectangle is not None:
                            ...
                            cv2.imwrite('C:\\Users\\yu guo long\\PycharmProjects\\face\\mtcnn\\mtcnn-keras-master\\data\\1\\' + '%d.jpg' % (
                                    num), new_img)
                            num+=1
                ...
                if rectangles != []:
                    ...
                    for rectangle in rectangles:
                        if rectangle is not None:
                            ...
                            # cv2.waitKey(0)
                            cv2.imwrite('C:\\Users\\yu guo long\\PycharmProjects\\face\\mtcnn\\keras-face-recognition-master\\data\\1\\'+'%d.jpg'%(num),new_img)
                            num+=1

if __name__ == '__main__':
    read__image('C:\\Users\\yu guo long\\PycharmProjects\\face\\mtcnn\\Glasses-recognition-master\\data\\11')